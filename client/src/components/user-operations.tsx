          ...
          <div className="pb-2 mb-4 border-b border-gray-100 mx-[-12px] px-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wide">User Operations</h3>
                {isPolling && (
          ...
          <div className="pb-2 mb-4 border-b border-gray-100 mx-[-12px] px-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wide">Cleanup Operations</h3>
