...
export default function UserOperations({ userOps, isPolling = false }: UserOperationsProps) {
  ...
  const renderOperation = (userOp: UserOp, index: number, isCleanup: boolean = false) => {
    ...
    return (
      <div key={index} className={`gradient-card-subtle rounded-lg overflow-hidden border ${isPending ? 'animate-pulse' : ''}`} style={{ borderColor: 'rgba(0,0,0,0.03)' }}>
            ...
            <div className="flex items-center space-x-4 flex-1">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <StatusTooltip status={userOp.executionStatus} />
                </div>
            ...
            <div className="space-y-6 pt-4 border-t border-gray-100">
              ...
              <div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    <TableDataField icon={Zap} label="Verification Gas Limit" value={formatGas(verificationGasLimit)} showCopy={false} />
                    <TableDataField icon={Zap} label="Call Gas Limit" value={formatGas(callGasLimit)} showCopy={false} />
                    <TableDataField icon={Fuel} label="Pre Verification Gas" value={formatGas(userOp.userOp.preVerificationGas)} showCopy={false} />
                    <TableDataField icon={Fuel} label="Max Priority Fee Per Gas" value={formatGas(maxPriorityFeePerGas) + ' wei'} showCopy={false} />
                    <TableDataField icon={Fuel} label="Max Fee Per Gas" value={formatGas(maxFeePerGas) + ' wei'} showCopy={false} />
                  </tbody>
                </table>
              </div>
      ...
      <div className="space-y-6">
        ...
        {regularOperations.length > 0 && (
          <div className="glass-root-card rounded-lg p-6">
            ...
            {/* Information Callout */}
            <div className="mb-4 relative overflow-hidden rounded-xl" style={{
              background: 'linear-gradient(135deg, rgba(59, 130, 246, 0.04) 0%, rgba(147, 197, 253, 0.06) 50%, rgba(219, 234, 254, 0.04) 100%)',
